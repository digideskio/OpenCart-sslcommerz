...
<form action="https://www.sslcommerz.com.bd/gwprocess/testbox/" method="post">
    <?php } else{?>
    
    <form action="https://www.sslcommerz.com.bd/gwprocess/" method="post">
  <?php }  ?>
...
<!--   <input type="hidden" name="success_url" value="<?php echo $callback; ?>" />-->
  ...
  <input type="hidden" name="opt_a" value="<?php echo $options; ?>" />
    <input type="hidden" name="desc" value="<?php echo $detail1_text; ?>" />
  <div class="buttons">
    <div class="right">
